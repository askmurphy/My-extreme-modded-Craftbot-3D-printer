...
| ![Alt text](img/modded-craftbot-rpi-wired.jpg?raw=true "RPi & XL4015 converter") | ![Alt text](img/cat6-chassis.avif?raw=true "Devine NCD chassisdeel crystal adapter D-size") |


| ![Alt text](img/SKR-V1.4-Turbo-pinout.jpg?raw=true "SKR v1.4 Turbo pinout") | ![Alt text](img/usb-panel-mount.jpg?raw=true "Panel mount USB B to USB B cable") | ![Alt text](img/cat6-chassis.avif?raw=true "") |
